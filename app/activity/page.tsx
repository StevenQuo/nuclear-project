        ...
        {activeTab === 'Riwayat' ? (
          ...
          inProcessActivities.map((activity) => {
            ...
            return (
              ...
              >
                {/* Image Section */}
                <div className="w-[140px] h-[140px] m-2.5 rounded-2xl bg-gray-100 relative overflow-hidden flex-shrink-0">
                  <div className="w-full h-full flex items-center justify-center text-gray-400 italic text-[10px] text-center p-2">
                    Processing Image
                  </div>
                </div>
                ...
                <div className="flex-1 p-4 pl-2 flex flex-col justify-between">
                  <div className="flex flex-col gap-1.5">
                    <div className="flex justify-between items-start">
                      <h3 className="text-base font-bold text-black leading-tight">{activity.supplier}</h3>
                      <span className="text-[10px] text-gray-300 font-medium">{activity.volume}</span>
                    </div>
                  ...
                  <div className="flex justify-between items-center mt-4">
                    <span className="text-[10px] text-gray-300 font-medium">{activity.price}</span>
